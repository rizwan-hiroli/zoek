                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" value="{{ old('gender') }}" autocomplete="gender" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="blood_group" type="text" class="form-control @error('blood_group') is-invalid @enderror" name="blood_group" value="{{ old('blood_group') }}" autocomplete="blood_group" autofocus>
                                @error('blood_group')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="gr_no" class="col-md-4 col-form-label text-md-right">{{ __('Gr.No.') }}</label>
                            <div class="col-md-6">
                                <input id="gr_no" type="text" class="form-control @error('gr_no') is-invalid @enderror" name="gr_no" value="{{ old('gr_no') }}" autocomplete="gr_no" autofocus>
                                @error('gr_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="id_proof" class="col-md-4 col-form-label text-md-right">{{ __('Id Proof') }}</label>
                            <div class="col-md-6">
                                <input id="id_proof" type="file" class="form-control @error('id_proof') is-invalid @enderror" name="id_proof" value="{{ old('id_proof') }}" autocomplete="id_proof" autofocus>
                                @error('id_proof')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
