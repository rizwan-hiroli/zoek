                ...
                @foreach($data as $dataValue)
                  <tr>
                    @foreach($listViewheaders['database_column'] as $database_cloumn)
                        @if($database_cloumn == 'logo')
                            <th>
                                <img src="{{asset('/storage/Company/'.$dataValue->logo)}}" alt='image' width='42'>
                            </th>
                        @else
                    ...
                    @endforeach
                        ...
                        <th>
                          <div class="text-center">
                              <a class="btn btn-dark btn-circle btn-sm" href="{{'company/'.$dataValue->id.'/edit'}}">
